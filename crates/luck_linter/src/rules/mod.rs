...
pub static RULES: &[RuleEntry] = &[
    ...
    RuleEntry::Whole(&type_check_inside_call::TypeCheckInsideCall),
    RuleEntry::Whole(&incorrect_stdlib_use::IncorrectStdlibUse),
    RuleEntry::Whole(&deprecated::Deprecated),
    RuleEntry::Node(
        &duplicate_conditions::DuplicateConditions,
        &duplicate_conditions::DuplicateConditions,
    ),
    RuleEntry::Whole(&invalid_lint_filter::InvalidLintFilter),
    RuleEntry::Whole(&for_range::ForRange),
    RuleEntry::Whole(&bad_string_escape::BadStringEscape),
    RuleEntry::Node(
        &comparison_precedence::ComparisonPrecedence,
        &comparison_precedence::ComparisonPrecedence,
    ),
    RuleEntry::Whole(&integer_parsing::IntegerParsing),
    ...
    RuleEntry::Whole(&format_string::FormatString),
    ...
    RuleEntry::Whole(&restricted_module_paths::RestrictedModulePaths),
    RuleEntry::Node(&empty_block::EmptyBlock, &empty_block::EmptyBlock),
    RuleEntry::Whole(&reversed_for_loop::ReversedForLoop),
    RuleEntry::Whole(&unbalanced_assignment::UnbalancedAssignment),
    RuleEntry::Whole(&if_same_then_else::IfSameThenElse),
    RuleEntry::Whole(&unreachable_code::UnreachableCode),
    RuleEntry::Whole(&must_use::MustUse),
    ...
    RuleEntry::Whole(&redundant_nil_init::RedundantNilInit),
    ...
    RuleEntry::Whole(&redundant_native_attribute::RedundantNativeAttribute),
    RuleEntry::Node(
