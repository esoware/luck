...
mod tests {
    ...
    fn ast_node_layouts() {
        ...
        check_layouts! {
            ...
            stmt::FunctionDecl => 240,
            stmt::LocalFunction => 216,
            stmt::Attribute => 48,
            stmt::AttributedName => 88,
